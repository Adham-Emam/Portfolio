                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">+20 112 800 0832</p>
                    </div>
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-4">
                    ...
                    full-time positions. If you have a project that you want to
                    get started, think you need my help with something, or just
